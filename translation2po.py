...
"""
translation2po.py
This script is used to translate the {lang}/chsdi.po-files of CHSDI (more about CHSDI: https://redmine.bgdi.admin.ch/projects/mf-chsdi).

Author: Tobias Reber
Version: 0.7
Usage: /home/ltret/chsdi/buildout/bin/python translation2po.py /home/ltret/chsdi/chsdi/i18n/
"""
...
for lang in config["langs"]:
    ...
    for var_msgid in var_arr:
        ...
        try:
            myString += "msgstr \"" + translationDict[lang][unicode(var_msgid)].replace("'","\\\'") + "\"\n\n"
        except:
